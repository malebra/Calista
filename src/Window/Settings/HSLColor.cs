...
namespace Calista.FireplaySupport
{
    ...
    public class HSLColor
    {
        ...
        public string RGB { get => ColorTranslator.ToHtml((Color)this); set { var temp = (HSLColor)ColorTranslator.FromHtml(value); hue = temp.hue; saturation = temp.saturation; luminosity = temp.luminosity; } }
